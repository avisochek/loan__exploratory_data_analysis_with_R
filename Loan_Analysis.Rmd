...
loanData$IncomeRange <- factor(loanData$IncomeRange,levels=c("Not displayed","Not employed","$0","$1-24,999","$25,000-49,999","$50,000-74,999","$75,000-99,999"))
...
ggplot(aes(x=LoanOriginationQuarter,y=LoanOriginalAmount,group=1),data=loanData)+
  geom_line(stat="summary",fun.y=mean)+
  theme(axis.text.x=element_text(angle = 45, hjust = 1))
#The average Loan amount went down steeply during the recession and has been rising sinve then.
